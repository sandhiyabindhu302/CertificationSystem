...
public partial class ApplicationDbContext : DbContext
{
    ...
    public virtual DbSet<Certificatecustomization> Certificatecustomizations { get; set; }

    public virtual DbSet<Certificatenotification> Certificatenotifications { get; set; }

    public virtual DbSet<CertificateBaseTemplate> CertificateBaseTemplates { get; set; }
    ...
    public virtual DbSet<Templatelogo> Templatelogos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;database=eepzdb;user=root;password=root", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.41-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Certificatecustomization>(entity =>
        {
            entity.HasKey(e => e.CustomizationId).HasName("PRIMARY");

            entity.ToTable("certificatecustomizations");

            entity.HasIndex(e => e.TemplateId, "TemplateId");

            entity.Property(e => e.ColorScheme).HasMaxLength(100);
            entity.Property(e => e.Elements).HasColumnType("text");
            entity.Property(e => e.FontStyle).HasMaxLength(100);
            entity.Property(e => e.ModifiedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime");

            entity.HasOne(d => d.Template).WithMany(p => p.Certificatecustomizations)
                .HasForeignKey(d => d.TemplateId)
                .HasConstraintName("certificatecustomizations_ibfk_1");
        });

        modelBuilder.Entity<Certificatenotification>(entity =>
        {
            entity.HasKey(e => e.NotificationId).HasName("PRIMARY");

            entity.ToTable("certificatenotifications");

            entity.HasIndex(e => e.CertificateId, "CertificateId");
            ...
            entity.HasOne(d => d.Certificate).WithMany(p => p.Certificatenotifications)
                .HasForeignKey(d => d.CertificateId)
                .HasConstraintName("certificatenotifications_ibfk_2");

            entity.HasOne(d => d.Employee).WithMany(p => p.Certificatenotifications)
                .HasForeignKey(d => d.EmployeeId)
                .HasConstraintName("certificatenotifications_ibfk_1");
        });
        ...
        modelBuilder.Entity<Certificatetemplate>(entity =>
        {
            ...
            entity.HasIndex(e => e.LogoId, "FK_Template_Logos");

            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime");
            entity.Property(e => e.TemplateLayout).HasColumnType("text");
            entity.Property(e => e.TemplateName).HasMaxLength(255);
            entity.Property(e => e.TemplateType).HasMaxLength(255);
            entity.Property(e => e.UpdatedAt)
                .ValueGeneratedOnAddOrUpdate()
                .HasColumnType("datetime");

            entity.HasOne(d => d.Logo).WithMany(p => p.Certificatetemplates)
                .HasForeignKey(d => d.LogoId)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("FK_Template_Logos");
        });
        ...
        modelBuilder.Entity<Employeecertificate>(entity =>
        {
            ...
            entity.Property(e => e.AreaOfAchievement).HasMaxLength(500);
            ...
            entity.Property(e => e.Status)
                .HasMaxLength(50)
                .HasDefaultValueSql("'Generated'");

            entity.HasOne(d => d.Employee).WithMany(p => p.Employeecertificates)
                .HasForeignKey(d => d.EmployeeId)
                .HasConstraintName("employeecertificates_ibfk_1");

            entity.HasOne(d => d.Template).WithMany(p => p.Employeecertificates)
                .HasForeignKey(d => d.TemplateId)
                .HasConstraintName("employeecertificates_ibfk_2");
        });
        ...
        modelBuilder.Entity<Templatelogo>(entity =>
        {
            entity.HasKey(e => e.LogoId).HasName("PRIMARY");

            entity.ToTable("templatelogos");

            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("CURRENT_TIMESTAMP")
                .HasColumnType("datetime");
            entity.Property(e => e.LogoName).HasMaxLength(255);
        });
        ...
        modelBuilder.Entity<Userauthentication>(entity =>
        {
            ...
            entity.Property(e => e.UserRole)
                ...
                .HasColumnType("enum('HR','Employee','Manager')");
